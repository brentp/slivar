...
requires "hts >= 0.2.15", "lapper", "nimgen", "binaryheap", "zip", "https://github.com/brentp/duktape-nim#dev", "https://github.com/brentp/bpbio", "https://github.com/brentp/nim-minizip", "argparse >= 0.7.0"
srcDir = "src"
installExt = @["nim"]
