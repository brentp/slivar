...
def read_dfs(i, j):
    ...
    df = pd.read_csv(sys.argv[i], sep="\t", index_col="sample").drop(["RGP_426_3", "RGP_430_3", "RGP_462_3"])
    dfo = df.join(pd.read_csv(sys.argv[j], sep="\t", index_col="sample").drop(["RGP_426_3", "RGP_430_3", "RGP_462_3"]))
