...
<<DONE
python plot-final-genome.py slivar-summ-results/exome.chd.gatk.slivar.summary.txt slivar-summ-results/exome.chd.gatk.ch.slivar.summary.txt slivar-summ-results/exome.chd.gatk.slivar.summary.txt slivar-summ-results/exome.chd.gatk.ch.slivar.summary.txt  slivar-summ-results/genome.ped 2>err
mv figure5-genome-counts.png supp-figure-sarcoma-exome-counts.png
mv figure5-genome-counts.eps supp-figure-sarcoma-exome-counts.eps
